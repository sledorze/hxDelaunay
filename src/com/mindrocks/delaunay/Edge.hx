...
@:final class Edge
{
	...
	public var delaunayLineBmp(get_delaunayLineBmp, null):BitmapData;
	...
	public var leftVertex(get_leftVertex, null) : Vertex;
	inline public function get_leftVertex():Vertex {
		return _leftVertex;
	}
	private var _rightVertex:Vertex;
	public var rightVertex(get_rightVertex, null):Vertex;
	...
	public var clippedEnds(get_clippedEnds, null):Dictionary;
